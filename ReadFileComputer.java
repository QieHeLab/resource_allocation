/******************************************************************************
 *  Compilation:  javac ReadFileComputer.java
 *  Execution:    java ReadFileComputer
 *  
...
public class ReadFileComputer extends ReadFile {
	...
	public static void main(String[] args) {
		...
		ReadFile test = new ReadFileComputer();
		test.readdata(4000);
	}
	...
	public List<ReadFile.Data_format> readdata (int size) {
		...
		try {
			...
			Scanner scanner = new Scanner(new File("./data/cpu_act.data"));
			int i = 0;
