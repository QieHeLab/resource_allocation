/******************************************************************************
 *  Compilation:  javac ReadFileCensus.java
 *  Execution:    java ReadFileCensus
 *  
...
public class ReadFileCensus extends ReadFile {
	...
	public static void main(String[] args) {
		...
		ReadFile test = new ReadFileCensus();
		test.readdata(6000);
	}
	...
	public List<ReadFile.Data_format> readdata (int size) {
		...
		try {
			...
			Scanner scanner = new Scanner(new File("./data/census_housing.data"));
			int i = 0;
		...
		System.out.println("Census housing data");
