/******************************************************************************
 *  Compilation:  javac CapacitatedLotSizingWOSegment.java
 *  Execution:    java CapacitatedLotSizingWOSegment
 *  
...
* O(n n lonB) where n is the number of periods and B is total amount of demands.  
* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
* This class is used to test the performance of the algorithm WITHOUT segment tree.
* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
* @author Zeyang Wu
*/
...
public class CapacitatedLotSizingWOSegment{
    ...
    //Constructor
	public CapacitatedLotSizingWOSegment() {
		this.numPeriod = 0; 
		this.demands = null;
		this.obj = null;
		this.prodCap = null;
	...
	public void ssp(long s, long[] prodFlow) {
		...
		while(curt < numPeriod) {
			...
			while (de[curt] > 0) {		
				...
				//range minimum, can be speeded up 
                
                for (int i = minIndex; i < curt; i++) {
                    if (bottleneck > u[i]) {
                        bottleneck = u[i];
                        bottleneckIndex = i;
                    }                   
