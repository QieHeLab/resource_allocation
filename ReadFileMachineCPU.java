/******************************************************************************
 *  Compilation:  javac ReadFileMachineCPU.java
 *  Execution:    java ReadFileMachineCPU
 *  
...
public class ReadFileMachineCPU extends ReadFile {
	...
	public static void main(String[] args) {
		...
		ReadFile test = new ReadFileMachineCPU();
		test.readdata(150);
	}
	...
	public List<ReadFile.Data_format> readdata (int size) {
		...
		try {
			...
			Scanner scanner = new Scanner(new File("./data/machine.data"));
			int i = 0;
